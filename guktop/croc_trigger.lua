...
function croc_spawns()
	...
	if(RandomNumber <=45) then
		...
		CrocUp = 2;
	elseif(RandomNumber > 45 and RandomNumber <= 53) then
		eq.spawn2(RandomCroc,0,0,470,1661,-70,66);
		eq.spawn2(RandomCroc,0,0,462,1653,-70,66);
		eq.spawn2(RandomCroc,0,0,450,1661,-70,66);
		CrocUp = 3;
	elseif(RandomNumber > 53 and RandomNumber <= 65) then
		eq.spawn2(RandomCroc,0,0,470,1661,-70,66);
		CrocUp = 1;
	elseif(RandomNumber > 65 and RandomNumber <= 95) then
...
function event_signal(e)
	CrocUp = CrocUp - 1;
	if(CrocUp == 0) then
		eq.set_timer("spawn timer",300000);
	end
end
